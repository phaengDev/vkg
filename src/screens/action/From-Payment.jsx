                        ...
                        <div className="card p-1 mb-3 border-3 border-gold bg-dark rounded-pill text-white text-center fs-25px show-price">
                            ...
                            <svg width="100%"  height="50"  xmlns="http://www.w3.org/2000/svg">
                                ...
                                <text font-family="arial" font-size="40" id="svg_1" y="45" x="288" fill="url(#grad2)" font-weight="bold">
                                    <tspan x="25%" y="37">{numeral(totalBalancePay).format('0,0')} ₭</tspan>
                                </text>
                            </svg>
                        </div>
                        ...
                        <table id="calcu" className='w-100'>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td className='w-25'><button type="button" className='btnCenter' onClick={() => handleClick('del')} ><i class="fa-solid fa-delete-left" /></button></td>
                                </tr>
                                <tr>
                                    ...
                                    <td className='w-25'><button type="button" className='btnCenter' onClick={() => handleClick('c')} >C</button></td>
                                </tr>
                                <tr>
                                    ...
                                    <td className='w-25'><button type="button" className='btnCenter' onClick={() => handleClick('All')} >ພໍດີ</button></td>
                                </tr>
                                <tr>
                        ...
                        <div className="row gx-3">
                            ...
                            <div className="col-8">
                                <button type='button' onClick={handlePayment} disabled={disabled} className="btn btn-green w-100 fs-14px rounded-3 fw-bold d-flex justify-content-center align-items-center py-3 m-0">
                                  {disabled}  ບັນທຶກຂາຍ <i className="fa fa-check ms-3" />
                                </button>
                            </div>
                        </div>
                    </div>
